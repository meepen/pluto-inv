...
SWEP.PrintName				= "SKULL-3 (B Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SKULL3.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("SKULL3.Fire") -- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "CROSSBONES-6 (B Mode)"
...
SWEP.Primary.DefaultClip			= 280				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull_3_b.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull_3.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["duel1"] = { type = "Model", model = "models/weapons/tfa_cso/w_skull_3.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.946, 2.982, -0.973), angle = Angle(-180, -100, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["duel1+"] = { type = "Model", model = "models/weapons/tfa_cso/w_skull_3.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(16.177, 3.997, 0.615), angle = Angle(0, -100, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsPos = Vector(7.875, -3.106, 0.879)
