...
SWEP.PrintName				= "Lightning Bazzi-1 (B Mode)"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("CartRed.Fire2")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_cartred_b.mdl" --Viewmodel path
