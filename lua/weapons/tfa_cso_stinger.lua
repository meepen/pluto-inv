...
--Firing related
SWEP.Primary.Sound 			= Sound("Stinger.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.Projectile = "stinger_arrow"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_stinger_arrow.mdl"
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stinger")
