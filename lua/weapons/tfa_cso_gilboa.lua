...
SWEP.PrintName				= "Gilboa Carbine"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Gilboa.Fire")				-- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.210				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_gilboa.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_gilboa.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_gilboa")
