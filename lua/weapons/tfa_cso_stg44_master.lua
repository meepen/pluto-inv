...
SWEP.PrintName				= "STG44 Master"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stg44_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_stg44_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stg44_master")
