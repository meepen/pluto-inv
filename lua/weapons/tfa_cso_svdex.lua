...
--Firing related
SWEP.Primary.Sound 			= Sound("SVDEX.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Sound = Sound("SVDEX.Launcher")

SWEP.Secondary.Projectile = "svdex_nade"
SWEP.Secondary.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl"
SWEP.Secondary.ProjectileVelocity = 1800
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_svdex.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_svdex.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_svdex")
