...
SWEP.PrintName			  = "M249 Veteran"	 -- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound		  = Sound("M249EP.Fire")			  -- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel		  = "models/weapons/tfa_cso/c_m249ep.mdl" --Viewmodel path
...
SWEP.WorldModel		 = "models/weapons/tfa_cso/w_m249ep.mdl" -- Weapon world model path
...
SWEP.Secondary.BashHitSound_Flesh = Sound("M249EP.Hit","M249EP.Hit2")

SWEP.Secondary.BashDamageType = bit.bor(DMG_SLASH,DMG_ALWAYSGIB)
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m249ep")
