...
SWEP.PrintName				= "VULCANUS-1 (A-Mode)"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("VULCANUS1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "HELLFIRE-2 (A-Mode)"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vulcanus_1_a.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 76		-- This controls how big the viewmodel looks.  Less is more.
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_vulcanus_1.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["vulcanus1"] = { type = "Model", model = "models/weapons/tfa_cso/w_vulcanus_1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.012, 1.628, -1.18), angle = Angle(180, -100, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["vulcanus1+"] = { type = "Model", model = "models/weapons/tfa_cso/w_vulcanus_1.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.168, 1.628, 1.042), angle = Angle(0, -100, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
