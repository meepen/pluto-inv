...
SWEP.PrintName				= "Luger P08 - Gold"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Luger.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "Luger Pride 16 - Gold"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_luger_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.Spread		= .0165					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0115	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_luger_gold.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_luger_gold.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(3.765, 0, 0.944)
SWEP.IronSightsAng = Vector(1.49, -1.642, -1.525)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger_gold")
