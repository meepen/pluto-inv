...
SWEP.PrintName				= "FN P90 Lapin"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "P-CHAN!!!! (PLEASE NERF THIS S**T)"
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_pchan")
