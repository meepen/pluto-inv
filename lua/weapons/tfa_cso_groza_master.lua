...
SWEP.PrintName				= "OTs-14 Groza Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickHorizontal			= 0.150					-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_groza_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_groza_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_groza_master")
