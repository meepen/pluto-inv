...
SWEP.PrintName				= "THANATOS-5"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("THANATOS5.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown			= 0.095					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thanatos_5.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_thanatos_5.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thanatos5")
