...
SWEP.Primary.Damage		= 68					-- Damage, in standard damage points.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_python.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_python.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsAng = Vector(0.703, -1.77, -3)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_python")
