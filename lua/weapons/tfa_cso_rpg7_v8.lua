...
SWEP.PrintName				= "RPG-7 Master"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("RPG7.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 750					-- Damage, in standard damage points.
...
SWEP.ProjectileEntity = "rocket_rpg7_v8" --Entity to shoot
SWEP.ProjectileVelocity = 10000 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_rpg7_rocket.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_rpg7_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_rpg7_v8.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.388, -2.31, -3.366)
SWEP.IronSightsAng = Vector(18.81, 10.236, -8.197)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_rpg7_v8")
