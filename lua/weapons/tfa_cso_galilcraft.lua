...
SWEP.PrintName				= "Galil Maverick"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("GalilCraft.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_galilcraft.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_galilcraft.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.056, -5.521, 1.827)
SWEP.IronSightsAng = Vector(-1.397, 0.007, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_galilcraft")
