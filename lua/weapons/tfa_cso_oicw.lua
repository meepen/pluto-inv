...
--Firing related
SWEP.Primary.Sound 			= Sound("OICW.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 41					-- Damage, in standard damage points.
...
SWEP.Secondary.Ent = "oicw_nade"

SWEP.Secondary.Model = "models/weapons/SOV_grenade.mdl" --Projectile Model
SWEP.Secondary.Damage = 200 --Grenade Damage
SWEP.Secondary.Velocity = 1500 --Grenade Velocity
SWEP.Secondary.Delay = 2.75 --Delay in seconds
SWEP.Secondary.Sound = Sound("OICW.FireNade") --Firing sound
SWEP.Secondary.Recoil = Angle(-5,1,0) --Recoil Dir

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Gordon's Lost Rifle"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_oicw.mdl" --Viewmodel path
...
SWEP.VMPos = Vector(6.4, 0, 0)
SWEP.VMAng = Vector(1.19, 5.299, -2)
SWEP.VMPos_Additive = false

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_oicw.mdl" -- same case UHGI;DFSD/
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_oicw")
