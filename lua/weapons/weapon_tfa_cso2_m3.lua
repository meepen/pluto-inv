...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m3.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "M3 Super Blaster"
SWEP.NZPaPReplacement 	= "tfa_cso2_m3boom"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m3.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m3.mdl" -- Weapon world model path
