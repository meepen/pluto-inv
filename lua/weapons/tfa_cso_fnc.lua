...
SWEP.PrintName				= "FNC"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("FNC.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_fnc.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_fnc.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.982, -2.4, 0.5)
SWEP.IronSightsAng = Vector(0.4, 1.001, 0)
...
SWEP.BlowbackVector = Vector(-0.035,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fnc")
