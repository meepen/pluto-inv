...
SWEP.PrintName				= "Milkor M32 MGL"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Milkor M32 MGL.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Milked M32 Nukelobber"
...
SWEP.ProjectileEntity = "milkor_m32_mgl_nade" --Entity to shoot
SWEP.ProjectileVelocity = 1800 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_m32.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m32.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(9.907, -8.169, -0.588)
SWEP.IronSightsAng = Vector(6.532, 10.081, -3.287)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_milkorm32")
