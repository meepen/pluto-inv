...
SWEP.NZPaPReplacement 	= "tfa_cso_bendita_v6"	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bendita.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bendita.mdl" 
