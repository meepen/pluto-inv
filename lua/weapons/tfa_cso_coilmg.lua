...
SWEP.PrintName				= "Coil Machine Gun"		
SWEP.Slot				= 3				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
--Firing related
SWEP.Primary.Sound 			= Sound("CoilMG.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_coilmg.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_coilmg.mdl" 
...
SWEP.MuzzleFlashEffect = "cso_muz_coilmg" 

--Tracer Stuff

SWEP.Tracer				= 0		
SWEP.TracerName 		= "cso_tra_coilmg" 	
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_coilmg")
