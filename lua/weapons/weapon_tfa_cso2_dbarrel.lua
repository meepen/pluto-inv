...
SWEP.PrintName				= "Double Defence"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_dbarrel.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_dbarrel.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_dbarrel.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.181, 0, 5.243)
SWEP.IronSightsAng = Vector(-3.369, 0.286, -1.487)
