...
SWEP.PrintName				= "MG3 Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.ClipSize			= 220					-- This is the size of a clip
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg3_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg3_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg3_v8")
