...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Jack-o'-Lantern"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_pumpkin.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_pumpkin.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("pumpkin")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_pumpkin")
