...
SWEP.PrintName				= "MG42"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MG42.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ClipSize			= 95					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 295				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg42.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg42.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.53, -3.5, 2.4)
SWEP.IronSightsAng = Vector(1.06, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg42")
