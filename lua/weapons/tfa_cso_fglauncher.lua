...
SWEP.PrintName				= "FG-Launcher"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("FGLauncher.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ProjectileEntity = "fglauncher_nade" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_fglauncher.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_fglauncher.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(7.28, 0, -1.295)
SWEP.IronSightsAng = Vector(2.723, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fglauncher")
