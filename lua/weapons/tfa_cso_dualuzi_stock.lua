...
SWEP.PrintName				= "Dual Uzi (B Mode)"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualuzistock.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dualuzi_r.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["dual"] = { type = "Model", model = "models/weapons/tfa_cso/w_dualuzi_l.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.079, 1.292, 3), angle = Angle(0, 81.939, 0.534), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualuzi_stock")
