...
SWEP.PrintName				= "L85A2"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("L85A2.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_l85a2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_l85a2.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(4.368, -2.814, -0.52)
SWEP.IronSightsAng = Vector(3.5, -0.1, 4.4)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_l85a2")
