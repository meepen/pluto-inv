...
--Firing related
SWEP.Primary.Sound 			= Sound("Bizon.Fire")				
...
SWEP.NZPaPName				= "64 Russian Bias"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bizon.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bizon.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bizon")
