...
SWEP.PrintName				= "AI AS50 Pink Gold"		
SWEP.Slot				= 3				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_as50g.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_as50g.mdl" 
