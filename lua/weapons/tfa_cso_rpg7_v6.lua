...
SWEP.PrintName				= "RPG-7 Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPReplacement 	= "tfa_cso_rpg7_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ProjectileEntity = "rocket_rpg7_v6" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_rpg7_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_rpg7_v6.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_rpg7_v6")
