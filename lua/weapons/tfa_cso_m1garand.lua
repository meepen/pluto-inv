...
--Firing related
SWEP.Primary.Sound 			= Sound("GARAND.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1garand.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1garand.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.026, -6.7, 3.39)
SWEP.IronSightsAng = Vector(0.2, 0.05, 0)
...
SWEP.PingSound = Sound("GARAND.Fire2") --replace with your sound ID

DEFINE_BASECLASS(SWEP.Base)

function SWEP:PrimaryAttack( ... )
  local cl = self:Clip1()
  local v = BaseClass.PrimaryAttack(self, ...)
  if self:Clip1() <= 0 and math.Round(cl)==1 then
	self:EmitSound(self.PingSound)
  end
  return v
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1garand")
