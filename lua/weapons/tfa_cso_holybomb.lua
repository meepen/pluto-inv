...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Holy Bomb"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "The Coming of Christ"
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_holybomb.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_holybomb.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("holybomb")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 800 -- Entity Velocity
SWEP.Velocity_Underhand = 425 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_holybomb")
