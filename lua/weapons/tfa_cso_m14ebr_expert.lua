...
SWEP.PrintName				= "M14 EBR Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M14.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Battle Rifle Expert"
SWEP.NZPaPReplacement 	= "tfa_cso_m14ebr_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 22					-- This is the size of a clip
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m14_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m14_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m14ebr_expert")
