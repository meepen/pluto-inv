...
SWEP.PrintName				= "Divine Lock"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Flintlock.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .0185	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_flintlock_pistol.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_flintlock_pistol.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.99, 0, 1.1)
SWEP.IronSightsAng = Vector(-2.678, 2.9, -6.014)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_divinelock")
