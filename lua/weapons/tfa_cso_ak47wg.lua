...
SWEP.PrintName				= "AK-47 White Gold"		
SWEP.Slot				= 2				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
SWEP.NZPaPName				= "Make Stalin Proud"
SWEP.NZPaPReplacement 	= "tfa_cso_g_ak47"	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47wg.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47wg.mdl" 
...
SWEP.BlowbackBoneMods = {
	["bone52"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2, -0.5), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ak47wg")
