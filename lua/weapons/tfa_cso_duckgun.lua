...
SWEP.PrintName				= "Special Duck Foot Gun"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("DuckGun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_duck_musket.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_duck_musket.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_duckgun")
