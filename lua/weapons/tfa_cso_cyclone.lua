...
--Firing related
SWEP.Primary.Sound 			= Sound("Cyclone.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_cyclone.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_cyclone.mdl" 
...
SWEP.Tracer				= 0		
SWEP.TracerName 		= "cso_tra_cyclone" 	
