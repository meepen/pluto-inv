...
SWEP.PrintName				= "Brick Piece T50 (A Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("T50.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi				= 675					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Lego PKM"
SWEP.NZPaPReplacement 	= "tfa_cso_tank"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_t50.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_t50.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.19, 0, 0.629)
SWEP.IronSightsAng = Vector(1.268, 3.2, 0.707)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_t50")
