...
SWEP.PrintName				= "Hunter Killer X-7"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("X-7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_x-7.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_x-7.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.394, -4.52, 1.725)
SWEP.IronSightsAng = Vector(0.312, 2.173, -0.569)
...
SWEP.BlowbackVector = Vector(-0.04,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_x-7")
