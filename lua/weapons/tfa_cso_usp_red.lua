...
SWEP.PrintName				= "USP45 Red"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "SNAKE (Red Edition)"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_usp_red.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_usp_red.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_usp_red")
