...
SWEP.PrintName				= "Sha Wujing Dual Handgun"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Wujing.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Auto Meh"
SWEP.NZPaPReplacement 	= "tfa_cso_infinityex1"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 216				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_monkeywpnset2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_monkeywpnset2.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["otherpist"] = { type = "Model", model = "models/weapons/tfa_cso/w_monkeywpnset2.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.479, 1.012, 4.055), angle = Angle(-10, 78.515, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualshawujing")
