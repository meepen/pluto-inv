...
SWEP.PrintName				= "K1A Maverick"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("K1AMaverick.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "After-Market Padatat"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_k1a_maverick.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_k1a_maverick.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.119, 0.012, 2.829)
SWEP.IronSightsAng = Vector(2.678, -0.137, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_k1a_maverick")
