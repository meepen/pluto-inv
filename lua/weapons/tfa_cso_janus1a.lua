...
SWEP.PrintName				= "JANUS-1 (A Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Janus1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 22					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 22					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Hand-Held Domination 149"
SWEP.NZPaPReplacement 	= "tfa_cso_m79_gold"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ProjectileEntity = "janus1a_nade" --Entity to shoot
SWEP.ProjectileVelocity = 1500 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_janus1a.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_janus1.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.73, 0.698, -1.6)
SWEP.IronSightsAng = Vector(-0.071, 0.135, 3.372)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_janus1a")
