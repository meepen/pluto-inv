...
SWEP.PrintName				= "Brick Piece T50 (B Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TANK.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 1500					-- Damage, in standard damage points.
SWEP.DamageType = DMG_BULLET --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= false					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 15					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 15					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Putanginamal"
SWEP.NZPaPReplacement 	= "tfa_cso_t50"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.IronAccuracy = .0275	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ProjectileEntity = "tank_missile" --Entity to shoot
SWEP.ProjectileVelocity = 9600 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_tank_missile.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_tank.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tank.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.744, 0.698, -1.53)
SWEP.IronSightsAng = Vector(-0.071, 0, 3.372)
...
function SWEP:Holster( ... )
	self:StopSound("TANK.Idle")
	self:StopSound("TANK.Idle2")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tank")
