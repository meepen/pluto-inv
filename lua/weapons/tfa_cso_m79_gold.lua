...
SWEP.PrintName				= "M79 Gold"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 33					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 33					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ProjectileEntity = "m79_gold_nade" --Entity to shoot
SWEP.ProjectileVelocity = 2048 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_m79_gold.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m79_gold.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m79_gold")
