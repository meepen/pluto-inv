...
SWEP.PrintName				= "Beretta ARX-160"		
SWEP.Slot				= 2				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
SWEP.NZPaPName				= "ARX"
--SWEP.NZPaPReplacement 	= "tfa_cso_arx160_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.180				
SWEP.Primary.KickDown			= 0.135					
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_arx160.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_arx160.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_arx160")
