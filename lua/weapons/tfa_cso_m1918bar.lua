...
--Firing related
SWEP.Primary.Sound 			= Sound("BAR.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1918bar.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1918bar.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.011, -3.4, 3.766)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1918bar")
