...
--Firing related
SWEP.Primary.Sound 			= Sound("UZI.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Carl Johnson"
SWEP.NZPaPReplacement 	= "tfa_cso_dualuzi"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 160				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickDown			= 0.155					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.205					-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.Spread		= .0185					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_uzi.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_uzi.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.8125, -3, 0.71)
SWEP.IronSightsAng = Vector(-2.85, 4.355, -6.841)
...
SWEP.BlowbackVector = Vector(-0.08,-1,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_uzi")
