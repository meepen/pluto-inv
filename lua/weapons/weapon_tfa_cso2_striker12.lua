...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_striker12.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 352 -- This is in Rounds Per Minute / RPM

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "SuperStriker-24"
...
SWEP.Primary.DefaultClip = 12 * 5 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_striker12.mdl" --Viewmodel path
...
SWEP.VMPos = Vector(0,-2.5,0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng = Vector(0,0,0) --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
SWEP.VMPos_Additive = false --Set to false for an easier time using VMPos. If true, VMPos will act as a constant delta ON TOP OF ironsights, run, whateverelse

--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_striker12.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.099, 0, 0.519)
SWEP.IronSightsAng = Vector(0, 0, 3.95)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.0,-4,0.0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1, 0, -1.377) }
}
