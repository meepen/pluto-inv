...
SWEP.PrintName				= "HK121 Custom"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("HK121_Custom.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Ent = "hk121_custom_nade"
...
SWEP.Secondary.Sound = Sound("HK121_Custom.Fire2")
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_hk121_custom.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_hk121_custom.mdl" -- Worldmodel path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_hk121_custom")
