...
SWEP.PrintName				= "PP2000"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PP2000.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "44 Russian Bias"
...
SWEP.Primary.ClipSize			= 44					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 164				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickHorizontal			= 0.185					-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_pp2000.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_pp2000.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_pp2000")
