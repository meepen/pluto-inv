...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_tribarrel.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 85 * 2 / 16 -- Damage, in standard damage points.
SWEP.Primary.NumShots = 16 * 3 / 2 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic = false -- Automatic/Semi Auto
SWEP.Primary.RPM = 400 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Displayed = 20 -- This is in Rounds Per Minute / RPM
SWEP.Primary.DamageType = bit.bor(DMG_AIRBOAT,DMG_BULLET,DMG_ALWAYSGIB)

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Boomstick"
...
--Recoil Related
SWEP.Primary.KickUp = 1.6 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 1.4-- This is the maximum downwards recoil (skeet)
...
--Range Related
SWEP.Primary.Range = 75 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_tribarrel.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_tribarrel.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.852, -0.843, 4.719)
SWEP.IronSightsAng = Vector(-4.5, 0.917, 1.702)
...
SWEP.BlowbackVector = Vector(0.01,-0.5,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -14.386, 0) },
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.098, -9.789, 0) }
}
...
function SWEP:Think2( ... )
	if self:GetLastActivity() == ACT_VM_RELOAD and self.OwnerViewModel:GetCycle() < 0.8 then
		for k,t in pairs( self.ViewModelBoneMods ) do
			if not istable(t) then break end
