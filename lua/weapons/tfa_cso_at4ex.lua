...
--Firing related
SWEP.Primary.Sound 			= Sound("AT4.Fire")				
...
SWEP.ProjectileEntity = "at4ex_rocket" 
SWEP.ProjectileVelocity = 35000 
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_at4_rocket.mdl" 

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_at4ex.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_at4ex.mdl" 
...
SWEP.Secondary.ScopeTable = {
	["ScopeMaterial"] =  Material("scope/at4/at4cs_scope.png", "smooth"),
...
SWEP.IronSightsPos = Vector(6.412, -11.822, 9.428)
SWEP.IronSightsAng = Vector(-0.504, -5.97, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_at4ex")
