...
SWEP.PrintName				= "MG36 XMAS"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MG36XMAS.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("MG36XMAS.Fire") -- This is the sound of the weapon, when silenced.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg36_xmas.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg36_xmas.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.447, -1.448, -0.106)
SWEP.IronSightsAng = Vector(0, 0, -2.21)
...
SWEP.TracerName 		= "cso_tra_xmas" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg36_xmas")
