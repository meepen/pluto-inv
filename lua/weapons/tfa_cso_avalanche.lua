...
--Firing related
SWEP.Primary.Sound 			= Sound("Avalanche.Fire")				
SWEP.Primary.SilencedSound = Sound("Avalanche.Fire") 
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_avalanche.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_avalanche.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_avalanche")
