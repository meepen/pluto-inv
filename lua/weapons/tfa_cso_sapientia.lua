...
SWEP.PrintName				= "Sapientia"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Sapientia.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sapientia.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sapientia.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(4.25, 0, 1.73)
SWEP.IronSightsAng = Vector(0.3, -1.65, -2.85)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sapientia")
