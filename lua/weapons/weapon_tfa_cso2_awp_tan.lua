...
SWEP.PrintName				= "AWP Tan"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_awp.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 162 -- Damage, in standard damage points.
...
SWEP.NZPaPName				= "S-Senpai Awp-tan"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_awp_tan.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_awp_tan.mdl" -- Weapon world model path
...
--[[ATTACHMENTS]]--
SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "cso2_lewd" }, sel = 0 }
}

DEFINE_BASECLASS( SWEP.Base )

SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.777, -11.405, 0) },
	["ValveBiped.Bip01_R_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-0, 0, 0) },
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-0, -5, 0) }
}
