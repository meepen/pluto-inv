...
SWEP.PrintName				= "Triple Tactical Knife"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Projectile = "tacticalknife_ex2"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_tknifeex2.mdl"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tknifeex2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tritacknife.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tritacknife")
