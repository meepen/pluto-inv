...
SWEP.PrintName				= "M16A1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M16A1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ClipSize			= 31					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 121				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m16a1.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
    ["Bone54"] = { scale = Vector(1, 1, 1), pos = Vector(-1, 0, 0), angle = Angle(-7, 0, 0) },
    ["Bone56"] = { scale = Vector(1, 1, 1), pos = Vector(-0.25, 0.2, 0.45), angle = Angle(-5, 2, 0) },
    ["Bone52"] = { scale = Vector(1, 1, 1), pos = Vector(-0.2, 0.25, 0.65), angle = Angle(-5, 2, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m16a1.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.386, -6.334, 2.266)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m16a1")
