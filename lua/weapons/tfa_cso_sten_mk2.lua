...
SWEP.PrintName				= "Sten Mk2"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("StenMK2.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Wallet-Fed ATTACK"
...
SWEP.Primary.DefaultClip			= 256				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.KickDown			= 0.145					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.235					-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.Spread		= .0335					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_sten_mk2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_sten_mk2.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.096, -1.4, 3.585)
SWEP.IronSightsAng = Vector(0.347, 0, 0)
...
SWEP.BlowbackVector = Vector(0,-1.3,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sten_mk2")
