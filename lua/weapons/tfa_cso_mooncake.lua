...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Mooncake"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName			= "Grenade"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_mooncake.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_mooncake.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("mooncake")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 1500 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mooncake")
