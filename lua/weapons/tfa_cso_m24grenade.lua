...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "M24 Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_m24_grenade.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_m24_grenade.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("m24grenade_thrown")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m24grenade")
