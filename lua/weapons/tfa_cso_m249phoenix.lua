...
SWEP.NZPaPName				= "Hail Da Phoenix"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m249p.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m249phoenix.mdl" -- Worldmodel path
...
function SWEP:Holster( ... )
	self:StopSound("M249P.Loop")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m249phoenix")
