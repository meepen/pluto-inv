...
SWEP.PrintName				= "Lightning Dao-1 (B Mode)"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("CartBlue.Fire2")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_cartblue_b.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_cartblue_b.mdl" -- Worldmodel path
