...
SWEP.PrintName				= "HK G11 Master"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g11_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_g11_v8.mdl" -- Worldmodel path
