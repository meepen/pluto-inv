...
SWEP.DisableChambering = true --Disable round-in-the-chamber --Disable round-in-the-chamber
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m60.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m60.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m60")
