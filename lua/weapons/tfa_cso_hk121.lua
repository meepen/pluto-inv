...
SWEP.PrintName				= "HK121"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("HK121.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Why are you papping this gun?"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_hk121.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_hk121.mdl" -- Worldmodel path
...
SWEP.ReticleScale = 0.65 --Scale of the reticle overlay
...
SWEP.IronSightsPos = Vector(7.591, -2.872, -0.445)
SWEP.IronSightsAng = Vector(-4.401, 3.72, 0.501)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_hk121")
