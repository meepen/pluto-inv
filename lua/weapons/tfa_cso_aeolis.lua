...
--Firing related
SWEP.Primary.Sound 			= Sound("Aeolis.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_aeolis.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_aeolis.mdl" 
...
SWEP.IronSightsPos = Vector(6.673, -0.091, -0.28)
...
function SWEP:Holster( ... )
	self:StopSound("Aeolis.Idle")
	return BaseClass.Holster(self,...)
end
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_aeolis")
