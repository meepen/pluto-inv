...
SWEP.PrintName				= "Lightning SMG-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("WaterGun.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_watergun.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_watergun.mdl" -- same case UHGI;DFSD/
