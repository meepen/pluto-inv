...
SWEP.PrintName				= "Kriss Super V"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SilencedSound = Sound("Kriss.FireSil") -- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "Kriss V"
SWEP.NZPaPReplacement 	= "tfa_cso_dualkriss"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.KickHorizontal			= 0.160					-- This is the maximum sideways recoil (no real term)
...
SWEP.IronSightsPos = Vector(8.005, -7.619, 0.241)
SWEP.IronSightsAng = Vector(0, 0.564, 3.292)
