...
SWEP.PrintName				= "Dual Infinity Custom"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.135				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_infinityex1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_infinity_red.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_infinityex1")
