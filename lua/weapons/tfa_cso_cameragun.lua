...
SWEP.PrintName				= "Lightning HMG-1"		
SWEP.Slot				= 3				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
--Firing related
SWEP.Primary.Sound 			= Sound("CameraGun.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_cameragun.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_cameragun.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_cameragun")
