...
SWEP.PrintName				= "SKULL-3 (A Mode)"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "CROSSBONES-6 (A Mode)"
SWEP.NZPaPReplacement 	= "tfa_cso_skull3_b"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull_3_a.mdl" --Viewmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull3_a")
