...
SWEP.PrintName				= "OTs-14 Groza"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.180				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_groza.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_groza.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_groza")
