...
--Firing related
SWEP.Primary.Sound 			= Sound("AN94.Fire")				
SWEP.Primary.Damage		= 29					
SWEP.DamageType = DMG_BULLET 
SWEP.Primary.NumShots	= 1 
SWEP.Primary.Automatic			= true					
SWEP.Primary.RPM				= 950				
SWEP.Primary.RPM_Burst				= 950					
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "2-Burst"
...
SWEP.DefaultFireMode 	= "2Burst" 
SWEP.FireModes = {"2Burst"}
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_an94.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_an94.mdl" 
...
SWEP.IronSightsPos = Vector(8.37, -4.7, 2.55)
SWEP.IronSightsAng = Vector(0.839, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_an94")
