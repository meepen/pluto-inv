...
SWEP.PrintName				= "MG36"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MG36.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 0.32 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg36.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg36.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.395, -2.958, 0)
SWEP.IronSightsAng = Vector(0, 0, -3.316)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg36")
