...
SWEP.PrintName				= "XM-1014"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_xm1014.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Xtra Murder 2028"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_xm1014.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_xm1014.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.218, 0, 2.48)
SWEP.IronSightsAng = Vector(-2.901, 3.299, -3.074)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = ( Vector(4.133, -1.405, 2.418) - SWEP.IronSightsPos ) * 2.5 --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.LuaShellEjectDelay = 0.00 --The delay to actually eject things
