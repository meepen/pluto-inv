...
SWEP.PrintName				= "Dart Pistol"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Dartpistol.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 80					-- Damage, in standard damage points.
SWEP.DamageType = bit.bor(DMG_BLAST,DMG_ALWAYSGIB,DMG_BULLET,DMG_SHOCK) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
SWEP.Primary.NumShots	= 1 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
SWEP.Primary.Automatic			= false					-- Automatic/Semi Auto
SWEP.Primary.RPM				= 75					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Burst				= 75					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "NERF OP"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dartpistol.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dartpistol.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.403, -3.84, 0.791)
SWEP.IronSightsAng = Vector(-1.152, 5.633, -2.722)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dartpistol")
