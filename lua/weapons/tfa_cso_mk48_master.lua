...
SWEP.PrintName				= "FN MK48 - Master"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Mien Komf 96 - Master"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mk48_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mk48_master.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mk48_master")
