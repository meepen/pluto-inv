...
SWEP.PrintName				= "AWM Gauss"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_awmgauss.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 400 -- Damage, in standard damage points.
SWEP.Primary.DamageType = bit.bor(DMG_BULLET,DMG_DISSOLVE) -- Damage, in standard damage points.
...
SWEP.NZPaPName				= "Face-Melter 5000"
...
SWEP.Primary.KickDown = 1.6-- This is the maximum downwards recoil (skeet)
...
--Range Related
SWEP.Primary.Range = 10000 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--Movespeed
SWEP.MoveSpeed = 0.82 --Multiply the player's movespeed by this.
...
SWEP.Secondary.IronFOV = 90 / 4 -- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
SWEP.IronSightsPos = Vector(7.239, -2.658, 2.299)
...
SWEP.BlowbackVector = Vector(0.09,-2,0.03) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.MuzzleFlashEffect = "tfa_muzzle_awp_ss" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
SWEP.SmokeParticle = nil --Smoke particle (ID within the PCF), defaults to something else based on holdtype; "" to disable
SWEP.EjectionSmokeEnabled = true --Disable automatic ejection smoke

--Shell eject override
SWEP.LuaShellEject = true --Enable shell ejection through lua?
SWEP.LuaShellEjectDelay = 18 / 30 --The delay to actually eject things
SWEP.LuaShellEffect = " " --The effect used for shell ejection; Defaults to that used for blowback

--Tracer Stuff
SWEP.TracerName 		= "tfa_tracer_awp_ss" 	--Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-2.599, -6.202, 0) }
}
