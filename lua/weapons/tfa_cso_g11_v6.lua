...
SWEP.PrintName				= "HK G11 Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 825					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 825					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.NZPaPReplacement 	= "tfa_cso_g11_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g11_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_g11_v6.mdl" -- Worldmodel path
