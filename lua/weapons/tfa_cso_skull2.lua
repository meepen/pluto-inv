...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull_2.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["duel1"] = { type = "Model", model = "models/weapons/tfa_cso/w_skull_2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(17.466, 2.966, -0.723), angle = Angle(-180, -100, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["duel1+"] = { type = "Model", model = "models/weapons/tfa_cso/w_skull_2.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(17.177, 3.947, 0.862), angle = Angle(0, -100, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
