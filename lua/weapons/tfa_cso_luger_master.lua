...
SWEP.PrintName				= "Luger P08 - Master"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName			= "Luger Pride 16 - Master"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_luger_silver"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 11					-- This is the size of a clip
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_luger_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_luger_master.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger_master")
