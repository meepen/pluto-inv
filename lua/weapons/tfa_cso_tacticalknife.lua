...
SWEP.Primary.Projectile = "tacticalknife"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tacticalknife.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tknife.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tacticalknife")
