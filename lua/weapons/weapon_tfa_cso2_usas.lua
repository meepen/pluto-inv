...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_usas12.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Ultimate Stopper Shotgun 24"
...
SWEP.IronSightsPos = Vector(6.778, 0, 1.08)
SWEP.IronSightsAng = Vector(1.123, 0, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.0,-4,0.1) --Vector to move bone <or root> relative to bone <or view> orientation.
