...
--Firing related
SWEP.Primary.Sound 			= Sound("TAR21.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Tar-Tar 42 Reflex"
...
SWEP.Primary.Spread		= .0145					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_tar_21.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-0.57, 5.406, 0.182), angle = Angle(37.5, 0, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_tar_21.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.44, 0, 2.079)
SWEP.IronSightsAng = Vector(2.418, 0.46, -2.152)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_tar_21")
