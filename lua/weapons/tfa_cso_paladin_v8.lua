...
SWEP.PrintName				= "AK-47 Paladin Expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 225					-- Damage, in standard damage points.
...
SWEP.Primary.KickHorizontal			= 0.016				-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_paladin_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_paladin_v8.mdl" -- I couldn't compile the Dark Knight's worldmodel either... why me
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_paladin_v8")
