...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Thunderstorm"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Korean Fireworks"
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_thunderstorm.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_thunderstorm.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("thunderstorm")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 700 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_thunderstorm")
...
function SWEP:Holster( ... )
	self:StopSound("Thunderstorm.Idle")
	return BaseClass.Holster(self,...)
end
