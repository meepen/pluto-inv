...
SWEP.PrintName				= "Infinity Silver"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Anri's Infinity"
...
--Recoil Related
SWEP.Primary.KickUp			= 0.160				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_infinity_silver.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_infinity_silver.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_infinite_silver")
