...
--Firing related
SWEP.Primary.Sound 			= Sound("AW50.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_aw50.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_aw50.mdl" 
...
SWEP.Scoped				= true  
SWEP.ScopeOverlayThreshold = 0.9 
