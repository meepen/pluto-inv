...
SWEP.ProjectileEntity = "rocket_rpg7" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_rpg7.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_rpg7.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_rpg7")
