...
SWEP.PrintName				= "Double Tactical Knife"		-- Weapon name (Shown on HUD)
...
SWEP.Type	= "Secondary Melee Weapon"
...
SWEP.Primary.NumShots	= 2 --The number of shots the weapon fires.  SWEP.Shotgun is NOT required for this to be >1.
...
SWEP.Primary.Projectile = "tacticalknife_ex"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_tknife.mdl"
SWEP.Primary.ProjectileVelocity = 4500 -- 76 meters to inches * 4/3 ( 16 / 12 hammer to inches )
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualtacknife.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_tknifeex.mdl" -- Weapon world model path
...
SWEP.Secondary.BashHitSound_Flesh = Sound("weapons/tfa_cso/knife/hit2.ogg")
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualtacknife")
