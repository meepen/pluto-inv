...
SWEP.PrintName				= "Petrol Boomer"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PetrolBoomer.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ProjectileEntity = "petrol_explosive" --Entity to shoot
SWEP.ProjectileVelocity = 3000 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_petrol.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_petrolboomer.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_petrolboomer.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_petrolboomer")
	SWEP.DrawWeaponSelection = TFA_CSO_DrawWeaponSelection
end

DEFINE_BASECLASS(SWEP.Base)
function SWEP:Holster( ... )
	self:StopSound("PetrolBoomer.Idle")
