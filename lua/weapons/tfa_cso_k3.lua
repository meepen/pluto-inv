...
SWEP.PrintName				= "K3"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("K3.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 575					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 575					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = false

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Korean Rambo"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_k3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_k3.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.51, -2.3, -0.95)
SWEP.IronSightsAng = Vector(5.05, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_k3")
