...
SWEP.PrintName				= "Luger P08"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName			= "Luger Pride 16"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger")
