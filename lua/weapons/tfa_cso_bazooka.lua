...
SWEP.PrintName				= "Bazooka"		-- Weapon name (Shown on HUD)
...
SWEP.ProjectileEntity = "bazooka_rocket" --Entity to shoot
SWEP.ProjectileVelocity = 10000 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_at4_rocket.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_bazooka.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bazooka.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bazooka")
