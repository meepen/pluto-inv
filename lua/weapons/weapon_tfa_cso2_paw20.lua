...
SWEP.PrintName				= "PAW-20"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_paw20.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso2/w_20mm_grenade.mdl"
SWEP.Primary.ProjectileVelocity = 1000 * 16-- 1000 feet to Hammer units
...
SWEP.Primary.DefaultClip = 28 -- This is the number of bullets the gun gives you, counting a clip as defined directly above.
SWEP.Primary.Ammo = "cso2_20mm" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_paw20.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_paw20.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-1, -2.5, 0)
...
SWEP.IronSightsPos = Vector(5.699, 0, -0.08)
