...
SWEP.PrintName				= "JANUS-1 (B Mode)"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Janus1.Fire2")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 270					-- Damage, in standard damage points.
...
SWEP.NZPaPReplacement 	= "tfa_cso_janus1a"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ProjectileEntity = "janus1b_nade" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_janus1b.mdl" --Viewmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_janus1b")
