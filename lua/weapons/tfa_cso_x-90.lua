...
SWEP.PrintName				= "Hunter Killer X-90"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("X-90.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound	= Sound("X-90.Fire")				-- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "Hacker's in the 90's"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_x-90.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_x-90.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.87, -4.432, 1.07)
SWEP.IronSightsAng = Vector(-5.983, 5.106, 0.389)
...
SWEP.BlowbackVector = Vector(0,-0.4,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_x-90")
