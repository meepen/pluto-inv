...
SWEP.PrintName				= "TURBULENT-5"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("TURBULENT5.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "TURBO-BLAZED-10"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_turbulent_5.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_turbulent_5.mdl" -- Worldmodel path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_turbulent5")
