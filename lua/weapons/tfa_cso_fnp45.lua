...
SWEP.PrintName				= "FNP-45"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_fnp45.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_fnp45.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.5455, -1.9, 0.95)
SWEP.IronSightsAng = Vector(0.85, -0.03, -0.4)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fnp45")
