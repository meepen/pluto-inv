...
SWEP.PrintName				= "FN F2000"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("F2000.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_f2000.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_f2000.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_f2000")
