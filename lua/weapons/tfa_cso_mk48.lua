...
SWEP.PrintName				= "FN MK48"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MK48.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Mien Komf 96"
SWEP.NZPaPReplacement 	= "tfa_cso_mk48_expert"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.KickHorizontal			= 0.0115				-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.Spread		= .0195					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mk48.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mk48.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(8.56, -5.987, 1.412)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mk48")
