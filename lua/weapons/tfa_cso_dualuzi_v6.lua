...
SWEP.PrintName				= "Dual Uzi Expert (A Mode)"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM				= 1800					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 1800					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dualuzi_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_dualuzi_v6_b.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["dual"] = { type = "Model", model = "models/weapons/tfa_cso/w_dualuzi_v6_a.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.079, 1.292, 3), angle = Angle(0, 81.939, 0.534), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualuzi_v6")
