...
SWEP.PrintName				= "VULCANUS-1 (B-Mode)"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("VULCANUS1.FireB")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "HELLFIRE-2 (B-Mode)"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vulcanus_1_b.mdl" --Viewmodel path
