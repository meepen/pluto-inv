...
--Firing related
SWEP.Primary.Sound 			= Sound("BALROG1.Fire")				
SWEP.Primary.Damage		= 55					
SWEP.DamageType = bit.bor(DMG_BULLET,DMG_BLAST,DMG_ALWAYSGIB,DMG_BURN) 
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_1.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog_1.mdl" 
...
SWEP.IronSightsPos = Vector(7.2405, -2.3, 0.27)
...
SWEP.BlowbackBoneMods = {
	["Bone42"] = { scale = Vector(1, 1, 1), pos = Vector(0, 4, 0), angle = Angle(0, 0, 0) },
}
...
--Impact Effects
SWEP.ImpactEffect = "tfa_metal_impact"
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_balrog1")
