...
SWEP.PrintName				= "Mauser C96"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.KickDown			= 0.14					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mauser_c96.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mauser_c96.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.055, 0, 2.36)
SWEP.IronSightsAng = Vector(3.198, 0, 0)
...
SWEP.BlowbackBoneMods = {
	["Bone16"] = { scale = Vector(1, 1, 1), pos = Vector(-2, 0, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mauser_c96")
