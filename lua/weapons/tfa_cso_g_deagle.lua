...
SWEP.PrintName				= "Desert Eagle Gold"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.200				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_g_deagle.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_g_deagle.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_g_deagle")
