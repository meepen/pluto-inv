...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_cartfrag.mdl"	
SWEP.WorldModel				= "models/weapons/tfa_cso/w_cartfrag.mdl"	
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_cartfrag")
