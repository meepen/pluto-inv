...
SWEP.PrintName				= "Crossbow Advance Expert"		
SWEP.Slot				= 3				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crossbowex_v6.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crossbowex_v6.mdl" 
