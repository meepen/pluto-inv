...
SWEP.PrintName				= "Luger P08 - Silver"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName			= "Alucard"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_luger_legacy"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_luger_silver.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_luger_silver.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_lug_s" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger_silver")
