...
--Firing related
SWEP.Primary.Sound 			= Sound("AWPZ.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_awpz.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_awpz.mdl" 
