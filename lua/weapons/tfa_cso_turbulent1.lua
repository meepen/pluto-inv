...
SWEP.PrintName				= "TURBULENT-1"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TURBULENT1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown			= 0.165					-- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal			= 0.145					-- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.Spread		= .0235					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_turbulent_1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_turbulent_1.mdl" -- Worldmodel path
...
function SWEP:Holster( ... )
	self:StopSound("TURBULENT5.Idle")
