...
SWEP.PrintName				= "STG44 Gold Edition"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 520					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 520					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stg44g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_stg44g.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stg44g")
