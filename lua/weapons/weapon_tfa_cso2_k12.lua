...
SWEP.PrintName				= "K12"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_k12.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Killbox 24X Ultimate"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_k12.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_k12.mdl" -- Weapon world model path
...
SWEP.Secondary.IronFOV = 90 / 3.4 -- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.
SWEP.IronSightsPos = Vector(6.383, -4.367, 1.32)
SWEP.IronSightsAng = Vector(-1.591, 2.815, -0.626)
--[[INSPECTION]]--
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(15, -15.386, 0) },
	["ValveBiped.Bip01_R_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-10, -9.789, 0) }
}
