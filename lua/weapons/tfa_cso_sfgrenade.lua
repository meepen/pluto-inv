...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_sfgrenade.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_sfgrenade.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("plasmagrenade")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_sfgrenade")
