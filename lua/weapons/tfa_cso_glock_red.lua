...
SWEP.PrintName				= "Glock 18 Red"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("Glock.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_glock_red.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_glock_red.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.945, -6.501, 3.065)
SWEP.IronSightsAng = Vector(0.31, 0.643, 0.325)
...
SWEP.BlowbackBoneMods = {
    ["usp_slide-handle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2.5, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_glock_red")
