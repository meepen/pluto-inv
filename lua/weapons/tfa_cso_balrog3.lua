...
--Firing related
SWEP.Primary.Sound 			= Sound("BALROG3.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_3.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog_3.mdl" 
...
SWEP.IronSightsPos = Vector(7, 0, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_balrog3")
