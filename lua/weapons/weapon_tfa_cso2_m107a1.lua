...
SWEP.PrintName				= "M107A1"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m107a1.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Mincer 107 A1"
SWEP.NZPaPReplacement 	= "tfa_cso2_m107a1"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m107a1.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m107a1.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-2, -4, -1)
SWEP.RunSightsAng = Vector(-11.869, -40.129, 16.056)
...
SWEP.IronSightsPos = Vector(5.079, 0, 1)
