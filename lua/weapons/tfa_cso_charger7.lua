...
--Firing related
SWEP.Primary.Sound 			= Sound("CHARGER7.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_charger_7.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_charger_7.mdl" 
...
SWEP.IronSightsPos = Vector(6.62, 0, -0.125)
SWEP.IronSightsAng = Vector(1.333, 0, 0)
