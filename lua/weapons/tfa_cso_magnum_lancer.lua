...
SWEP.PrintName				= "Magnum Launchcer"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnum_lancer.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnum_lancer.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_magnumlauncher" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_magnumlauncher" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnum_lancer")
...
if self.Secondary.Nextregen <= CurTime()  and self:Ammo2() < 10 then 
 ...
 self.Secondary.Nextregen =  CurTime()  + 3   ---3 seconds
...
local ent = ents.Create("sg_missile")
...
self:EmitSound( self:GetStat("Secondary.Sound") )
 self.Secondary.Nextregen =  CurTime()  + 3
