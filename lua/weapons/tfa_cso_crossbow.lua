...
SWEP.NZPaPReplacement 	= "tfa_cso_crossbowex"	
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crossbow.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crossbow.mdl" 
