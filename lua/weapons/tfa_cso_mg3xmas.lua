...
SWEP.PrintName				= "MG3 XMAS"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Late Christmas Present"
...
SWEP.Primary.DefaultClip			= 800				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg3_xmas.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg3_xmas.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg3xmas")
