...
SWEP.PrintName				= "XM8 Sharpshooter"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("XM8.Fire2")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Too Op Please Nerf"
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_xm8sharpshooter.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.839, -2.368, 1.103)
SWEP.IronSightsAng = Vector(0, 0, 8.845)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_xm8_sharpshooter")
