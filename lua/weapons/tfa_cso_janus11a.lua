...
SWEP.PrintName				= "JANUS-11 (A Mode)"		-- Weapon name (Shown on HUD)
SWEP.NZPaPName				= "DEZZ NUTS"			-- For nZombies. Pack-a-punch this gun to get this name!
...
--Firing related
SWEP.Primary.Sound 			= Sound("JANUS11.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_janus11a.mdl" --Viewmodel path
...
SWEP.ShellTime			= .40 -- For shotguns, how long it takes to insert a shell.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_janus11a")
