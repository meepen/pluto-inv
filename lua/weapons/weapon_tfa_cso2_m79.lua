...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m79.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Thumper Lumper 79"
...
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso2/w_40mm_grenade.mdl"
SWEP.Primary.ProjectileVelocity = 2992.13 * 16 / 12-- 76 meters to inches * 4/3 ( 16 / 12 hammer to inches )
...
SWEP.Primary.Ammo = "cso2_40mm" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m79.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m79.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.98, -8.726, 1.358)
SWEP.IronSightsAng = Vector(2.483, -0.283, 1.445)
--[[INSPECTION]]--
