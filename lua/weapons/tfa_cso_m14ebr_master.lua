...
SWEP.PrintName				= "M14 EBR Master"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Battle Rifle Master"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m14_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m14_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m14ebr_master")
