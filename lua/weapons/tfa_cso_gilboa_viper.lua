...
SWEP.PrintName				= "Gilboa Viper"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("GilboaViper.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickHorizontal			= 0.23					-- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_gilboa_viper.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_gilboa_viper.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_gilboa_viper")
