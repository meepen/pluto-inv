...
SWEP.PrintName				= "SCAR-L"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("SCAR.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scar_l.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scarl.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_scar_l")
