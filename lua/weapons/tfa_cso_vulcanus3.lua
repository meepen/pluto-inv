...
SWEP.PrintName				= "VULCANUS-3"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Vulcanus3.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown			= 0.035					-- This is the maximum downwards recoil (skeet)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vulcanus_3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_vulcanus_3.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_vulcanus3")
