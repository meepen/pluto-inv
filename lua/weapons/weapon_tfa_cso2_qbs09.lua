...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_qbs09.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_qbs09.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_qbs09.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(4.4, -2.237, 1.409)
SWEP.IronSightsAng = Vector(-0.625, 3.451, 2.457)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.115,-2,0.0) --Vector to move bone <or root> relative to bone <or view> orientation.
