...
--Firing related
SWEP.Primary.Sound 			= Sound("Balrog5.Fire")				
SWEP.Primary.Damage		= 45					
SWEP.DamageType = bit.bor(DMG_BULLET,DMG_BLAST,DMG_ALWAYSGIB) 
SWEP.Primary.NumShots	= 1 
SWEP.Primary.Automatic			= true					
SWEP.Primary.RPM				= 550					
SWEP.Primary.RPM_Semi				= 550					
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Explosive g36c"
...
SWEP.Primary.KickHorizontal			= 0.14					
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog5.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog5.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_balrog5")
