...
SWEP.PrintName				= "M99"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m99.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.Damage = 240 -- Damage, in standard damage points.
...
--SWEP.NZPaPName				= "Machine 120"
SWEP.NZPaPReplacement 	= "tfa_cso2_m95"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
--Range Related
SWEP.Primary.Range = 2000 * 39.3701 * 8 / 3 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m99.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m99.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(0, -2, -1.5)
SWEP.RunSightsAng = Vector(-7.869, -30.129, 16.056)
...
SWEP.IronSightsPos = Vector(5.92, 0, 0.879)
...
function SWEP:Think2( ... )
	if self:GetStatusEnd() < CurTime() and self:GetStatus() == TFA.GetStatus("shooting") then
		self:Reload(true)
	end
