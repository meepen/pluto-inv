...
SWEP.PrintName				= "PKM Fire"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_pkmfire.1") -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Pulveriser Hellstorm"
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_pkmfire.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_pkmfire.mdl" -- Weapon world model path
...
SWEP.RunSightsPos = Vector(-0.5, -6, 0)
...
SWEP.IronSightsPos = Vector(13.64, -6.871, 3.68)
SWEP.IronSightsAng = Vector(1.496, -0.073, 0)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(0.0,-4,0.05) --Vector to move bone <or root> relative to bone <or view> orientation.
...
function SWEP:Deploy( ... )
	...
	timer.Simple(0, function()
		if IsValid(self) and self:VMIV() then
			self:CleanParticles()
			ParticleEffectAttach( "cso2_pkmfire_01", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 3 )
			ParticleEffectAttach( "cso2_pkmfire_02", PATTACH_POINT_FOLLOW, self.OwnerViewModel, 4 )
		end
	end)
	return true
end