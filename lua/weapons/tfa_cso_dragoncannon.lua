...
SWEP.PrintName				= "Black Dragon Cannon"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Cannon.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 18					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 18					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_black_dragon_cannon.mdl" --Viewmodel path
