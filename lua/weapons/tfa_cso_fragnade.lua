...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "M67 Frag Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_fragnade.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_fragnade.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("fragnade")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fragnade")
