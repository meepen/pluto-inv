...
//SWEP.Manufacturer = "AR" --Gun Manufactrer (e.g. Hoeckler and Koch )
//SWEP.Type = "Rifle"
...
SWEP.PrintName			  = "M16A1 Veteran"	 -- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound		  = Sound("M16A1EP.Fire")			  -- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel		  = "models/weapons/tfa_cso/c_m16a1ep.mdl" --Viewmodel path
...
SWEP.WorldModel		 = "models/weapons/tfa_cso/w_m16a1ep.mdl" -- Weapon world model path
...
SWEP.Secondary.BashHitSound_Flesh = Sound("M249EP.Hit")

SWEP.Secondary.BashDamageType = bit.bor(DMG_SLASH,DMG_ALWAYSGIB)
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m16a1ep")
