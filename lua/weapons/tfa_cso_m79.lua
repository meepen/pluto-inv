...
--Firing related
SWEP.Primary.Sound 			= Sound("M79.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ProjectileEntity = "m79_nade" --Entity to shoot
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m79.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m79.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m79")
