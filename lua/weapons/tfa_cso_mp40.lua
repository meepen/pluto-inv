...
--Firing related
SWEP.Primary.Sound 			= Sound("MP40.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "The Afterburner"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mp40.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mp40.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.714, -5.2, 2.4)
SWEP.IronSightsAng = Vector(1.4, 0.05, -0.5)
...
SWEP.BlowbackVector = Vector(-0.01,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mp40")
