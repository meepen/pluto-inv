...
SWEP.PrintName				= "M60E4 Gold"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Rambo Mark Gold"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m60g.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m60g.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.69, -8.8, 3.6)
SWEP.IronSightsAng = Vector(0.35, 0.15, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m60g")
