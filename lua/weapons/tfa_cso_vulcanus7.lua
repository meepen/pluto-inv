...
SWEP.PrintName				= "VULCANUS-7"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Vulcanus7.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Sound = Sound("Vulcanus7.Fire2") --Firing sound
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_vulcanus7.mdl" --Viewmodel path
