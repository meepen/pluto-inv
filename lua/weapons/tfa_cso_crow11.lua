...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW11.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow11.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow11.mdl" 
