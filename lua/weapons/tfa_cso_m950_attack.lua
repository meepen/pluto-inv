...
SWEP.PrintName				= "M950 Attack"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M950Attack.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Barrel O' Laughs"
...
SWEP.Primary.ClipSize			= 58					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 290				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.IronAccuracy = .0145	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m950_attack.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m950_attack.mdl" -- Worldmodel path
...
SWEP.Secondary.IronFOV			= 47.5					-- How much you 'zoom' in. Less is more!  Don't have this be <= 0.  A good value for ironsights is like 70.

SWEP.IronSightsPos = Vector(6.037, -3.748, -1.185)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m950_attack")
