...
--Firing related
SWEP.Primary.Sound 			= Sound("HK416.FireUnsil1")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("HK416.FireSilenced") -- This is the sound of the weapon, when silenced.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_hk416.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_hk416.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.68, -5, 0.25)
SWEP.IronSightsAng = Vector(1.44, 0.88, 2.94)
...
SWEP.BlowbackVector = Vector(-0.02,-2,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_hk416")
