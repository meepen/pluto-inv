...
--Firing related
SWEP.Primary.Sound 			= Sound("Anaconda.Fire")				
SWEP.Primary.Damage		= 72.5					
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_anaconda.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_anaconda.mdl" 
...
SWEP.IronSightsPos = Vector(5.155, 0, 1.65)
SWEP.IronSightsAng = Vector(4.9, 0.1, -0.1)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_anaconda")
