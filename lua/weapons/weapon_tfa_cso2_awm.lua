...
SWEP.PrintName				= "AWM"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 56 -- This is in Rounds Per Minute / RPM

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Arctic Warfare Master"
...
SWEP.Primary.Ammo = "a" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_awm.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_awm.mdl" -- Weapon world model path
...
SWEP.SequenceRateOverride = {
	[ACT_VM_PRIMARYATTACK] = 56 / 60 * 1.3
