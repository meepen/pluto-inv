...
SWEP.PrintName				= "Infinity Red"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_infinite_red.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(8.324, -8.285, 10.741)
SWEP.IronSightsAng = Vector(-83, 2.375, -0.704)
...
SWEP.BlowbackVector = Vector(0,0,-2) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_infinite_red")
