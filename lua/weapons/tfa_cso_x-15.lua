...
SWEP.PrintName				= "Hunter Killer X-15"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("X-15.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound	= Sound("X-15.Fire")				-- This is the sound of the weapon, when silenced.
...
SWEP.NZPaPName				= "Hacker's in the 50's"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_x-15.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_x-15.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.979, -3.197, 1.703)
SWEP.IronSightsAng = Vector(6.265, 4.077, 0.389)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_x-15")
