...
SWEP.PrintName				= "Ultimax 100"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Ultimax100.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName			= "Ultimate Carnage 200"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ultimax100.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ultimax100.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.885, -3, 1.74)
SWEP.IronSightsAng = Vector(0, 0.03, -0.7)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ultimax100")
