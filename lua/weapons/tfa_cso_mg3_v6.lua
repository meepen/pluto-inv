...
SWEP.PrintName				= "MG3 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MG3.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.ClipSize			= 210					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 410				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mg3_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mg3_v6.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(6.15, 0, 1.11)
SWEP.IronSightsAng = Vector(0, 0.209, -3.855)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mg3_v6")
