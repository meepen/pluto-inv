...
--Firing related
SWEP.Primary.Sound 			= Sound("AUTOMAG.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_automagv.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_automagv.mdl" 
...
SWEP.IronSightsPos = Vector(5.8, 0, 1.394)
SWEP.IronSightsAng = Vector(-1.727, -0.21, -1.8)
...
SWEP.BlowbackBoneMods = {
	["bone52"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2.9, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_automagv")
