...
SWEP.PrintName				= "FN MK48 - Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Mien Komf 96 - Expert"
SWEP.NZPaPReplacement 	= "tfa_cso_mk48_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 135					-- This is the size of a clip
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mk48_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mk48_expert.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mk48_expert")
