...
SWEP.PrintName				= "Luger P08 - Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName			= "Luger Pride 16 - Expert"	-- What name this weapon should use when Pack-a-Punched.
SWEP.NZPaPReplacement 	= "tfa_cso_luger_gold"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_luger_expert.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_luger_expert.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger_expert")
