...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m60.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m60.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m60.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.55, -3.408, 0.68)
SWEP.IronSightsAng = Vector(1.9, 3.3, -0.21)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.225,-4,0.15) --Vector to move bone <or root> relative to bone <or view> orientation.
