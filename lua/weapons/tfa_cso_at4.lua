...
SWEP.NZPaPReplacement 	= "tfa_cso_at4ex"	
...
SWEP.ProjectileEntity = "at4_rocket" 
SWEP.ProjectileVelocity = 30000 
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_at4_rocket.mdl" 

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_at4.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_at4.mdl" 
...
SWEP.Secondary.IronFOV			= 25					

SWEP.IronSightsPos = Vector(5.473, -10.27, 7.091)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_at4")
