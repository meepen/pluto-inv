...
SWEP.PrintName				= "PKM Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("PKM.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Burst				= 875					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Russian LMG Bias"
SWEP.NZPaPReplacement 	= "tfa_cso_pkm_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.ClipSize			= 165					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 365				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.1625				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_pkm_v6.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 78		-- This controls how big the viewmodel looks.  Less is more.
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_pkm_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_pkm_expert")
