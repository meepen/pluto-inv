...
SWEP.PrintName				= "Desert Eagle Red"		
SWEP.Slot				= 1				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_deserteaglered.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_deserteaglered.mdl" 
...
SWEP.IronSightsPos = Vector(5.79, 0, 1.65)
SWEP.IronSightsAng = Vector(0.5, 1.1, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_deaglered")
