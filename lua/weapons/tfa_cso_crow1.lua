...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW1.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow1.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow1.mdl" 
