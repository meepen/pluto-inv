...
SWEP.PrintName				= "SKULL-4"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Skull4.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Double Death-14"
...
SWEP.Primary.ClipSize			= 48					-- This is the size of a clip
SWEP.Primary.DefaultClip			= 288				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_skull4.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_skull4.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["skull_4_wm_l"] = { type = "Model", model = "models/weapons/tfa_cso/w_skull4.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(11.128, 1.299, 3.611), angle = Angle(0, 84.621, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_skull4")
