...
--Firing related
SWEP.Primary.Sound 			= Sound("BALROG7.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_balrog_7.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_balrog7.mdl" 
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_balrog7")
