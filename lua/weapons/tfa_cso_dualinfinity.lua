...
SWEP.PrintName				= "Dual Infinity"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("DUALINFINITE.Fire")				-- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.150				-- This is the maximum upwards recoil (rise)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_infinity.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_infinity_black.mdl" -- Worldmodel path
...
SWEP.WElements = {
	["otherpist"] = { type = "Model", model = "models/weapons/tfa_cso/w_infinity_silver.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.479, 1.812, 2.755), angle = Angle(0, 75.515, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dualinfinity")
