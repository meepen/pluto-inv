...
SWEP.PrintName				= "HK G11"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_hk_g11.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_hk_g11.mdl" -- Worldmodel path
