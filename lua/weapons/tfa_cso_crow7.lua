...
--Firing related
SWEP.Primary.Sound 			= Sound("CROW7.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crow7.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crow7.mdl" 
