...
SWEP.PrintName				= "Dual MP7A1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("DMP7A1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "MegaPulverizer 14 x2"
...
SWEP.Primary.DefaultClip			= 320				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.StaticRecoilFactor = 0.16 	--Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_dmp7a1.mdl" --Viewmodel path
...
SWEP.WElements = {
	["mp7_2"] = { type = "Model", model = "models/weapons/tfa_cso/w_mp7a160r.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6, 1.8, 2.2), angle = Angle(0, 75,0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_dmp7a1")
