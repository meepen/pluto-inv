...
SWEP.PrintName				= "Desert Eagle Crimson Hunter Expert"		
SWEP.Slot				= 1				
SWEP.SlotPos				= 73			
SWEP.DrawAmmo				= true		
...
--Firing related
SWEP.Primary.Sound 			= Sound("CrimsonHunter.Fire")				
SWEP.Primary.Damage		= 150					
SWEP.DamageType = DMG_BULLET 
SWEP.Primary.NumShots	= 1 
SWEP.Primary.Automatic			= false					
SWEP.Primary.RPM				= 450					
SWEP.Primary.RPM_Semi				= 450					
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_crimson_hunter_expert.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_crimson_hunter_expert.mdl" 
...
SWEP.ScopeOverlayThreshold = 0.8 
...
SWEP.MuzzleFlashEffect = "cso_muz_crm_hnt_ex" 

--Tracer Stuff

SWEP.Tracer				= 0		
SWEP.TracerName 		= "cso_tra_crm_hnt_ex" 	
