...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m249.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m249.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m249.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(6.235, -0.936, 2.059)
SWEP.IronSightsAng = Vector(1.753, 5.3, 1.238)
--[[INSPECTION]]--
...
SWEP.BlowbackVector = Vector(-0.2,-2,0.07) --Vector to move bone <or root> relative to bone <or view> orientation.
