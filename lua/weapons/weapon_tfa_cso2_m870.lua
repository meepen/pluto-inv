...
SWEP.PrintName				= "M870"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfa_cso2_m870.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso2/c_m870.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso2/w_m870.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(5.28, -2.441, 1.24)
SWEP.IronSightsAng = Vector(1.717, 4.184, -2.204)
--[[INSPECTION]]--
