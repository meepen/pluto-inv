...
--Firing related
SWEP.Primary.Sound 			= Sound("Ak47_long.Fire")				
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47_long.mdl" 
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47_long.mdl" 
