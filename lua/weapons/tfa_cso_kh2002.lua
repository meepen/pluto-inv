...
SWEP.PrintName				= "KH-2002"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("KH2002.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Iranian Bull-pup"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_kh2002.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_kh2002.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.57, -2.01, 0.791)
SWEP.IronSightsAng = Vector(-0.244, -0.465, -0.839)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_kh2002")
