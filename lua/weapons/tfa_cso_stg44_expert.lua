...
SWEP.PrintName				= "STG44 Expert"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("STG44.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM				= 525					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 525					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
SWEP.FiresUnderwater = true

-- nZombies Stuff
SWEP.NZWonderWeapon		= false	-- Is this a Wonder-Weapon? If true, only one player can have it at a time. Cheats aren't stopped, though.
--SWEP.NZRePaPText		= "your text here"	-- When RePaPing, what should be shown? Example: Press E to your text here for 2000 points.
SWEP.NZPaPName				= "Sturmgewehr 44"
SWEP.NZPaPReplacement 	= "tfa_cso_stg44_master"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 122				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_stg44_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_stg44_v6.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.88, 0, 2.48)
SWEP.IronSightsAng = Vector(1.315, -0.141, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_stg44_expert")
