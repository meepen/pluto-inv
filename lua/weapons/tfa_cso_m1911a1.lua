...
SWEP.PrintName				= "M1911 A1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("M1911A1.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m1911a1.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m1911a1.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(5.789, -1.8, 1.98)
SWEP.IronSightsAng = Vector(0.879, 0.028, 0)
...
SWEP.BlowbackBoneMods = {
	["Bone26"] = { scale = Vector(1, 1, 1), pos = Vector(-2, 0.75, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m1911a1")
