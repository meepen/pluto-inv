...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Heart Bomb"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Happy Single Day"
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_heartbomb.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_heartbomb.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("heartbomb")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 900 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_heartbomb")
