...
--Firing related
SWEP.Primary.Sound 			= Sound("SCARH.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scarh.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scarh.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_scarh")
