...
SWEP.PrintName				= "Dark Legacy Luger"		-- Weapon name (Shown on HUD)
...
SWEP.MaterialTable = { [1] = "models/weapons/tfa_cso/luger_legacy/luger_legacy" }
--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound 			= Sound("Luger_Legacy.Fire")				-- This is the sound of the weapon, when you shoot.
SWEP.Primary.Damage		= 82					-- Damage, in standard damage points.
...
SWEP.NZPaPName			= "The Legacy"	-- What name this weapon should use when Pack-a-Punched.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_luger.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_luger.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_luger_legacy")
