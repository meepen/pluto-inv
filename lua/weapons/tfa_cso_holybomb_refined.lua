...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Holy Bomb Refined"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_holybomb_refined.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_holybomb_refined.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("holybomb_refined")	--NAME OF ENTITY GOES HERE
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_holybomb_refined")
