EFFECT.g_sModelIndexFireball3 = Material("sprites/sgmissilegs_plasma_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("MagnumLancer.MissileExplode", 180, 100 )
end
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 10), 256, 256, Color(255, 255, 255, 255))
end