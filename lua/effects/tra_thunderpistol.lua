...
function EFFECT:Init(data)
	...
	self.LifeTime = 0.5 + 0.013 * ((self.StartPos - self.EndPos):Length() ^ 0.5) -- Keep the particle relatively constant speed
...
function EFFECT:Render()
	...
	for i = 0, nlen * (1 - delta), 32 do
		...
		render.DrawBeam(prevspinpos, spinbeampos, 12, texcoord + i, texcoord + 1 + i, Color(255,222,0, self.Color.a))
		render.DrawBeam(prevspinpos2, spinbeampos2, 12, texcoord + i, texcoord + 1 + i, Color(255,222,0, self.Color.a))
