EFFECT.g_sModelIndexFireball3 = Material("sprites/trinity_flame")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	--self.Entity:EmitSound("Trinity.ExplodeRed", self.Pos, 180, 100 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 13), 0, 13))
	render.DrawSprite(self.Pos + Vector(0, 0, 75), 512, 512, Color(255, 255, 255, 255))
end