EFFECT.g_sModelIndexFireball3 = Material("sprites/fragnade_exp")
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 20), 0, 20))
	render.DrawSprite(self.Pos + Vector(0, 0, 30), 300, 300, Color(255, 255, 255, 255))
end