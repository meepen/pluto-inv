...
local Mat_Impact = Material("tracers/impact_m95tiger")
local Mat_Beam = Material("tracers/tracer_m95tiger")
...
local beamcol = Color(88, 205, 207)
local beamcol2 = Color(55, 183, 112)
...
function EFFECT:Render()
	...
	render.DrawSprite(endPos, 12, 12, Color(88, 205, 207))
