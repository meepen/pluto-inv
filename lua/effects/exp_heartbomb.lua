EFFECT.g_sModelIndexFireball3 = Material("sprites/heartbomb_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("HeartBomb.Explode", self.Pos, 180, 100 )
end
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 30), 256, 256, Color(255, 255, 255, 255))
end