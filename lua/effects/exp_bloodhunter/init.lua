EFFECT.g_sModelIndexFireball3 = Material("sprites/bloodnade_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("weapons/tfa_cso/fragnade/exp" ..math.random(1, 3) ..".wav", self.Pos, 180, 100 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 22), 0, 22))
	render.DrawSprite(self.Pos + Vector(0, 0, 70), 500, 500, Color(255, 255, 255, 255))
end