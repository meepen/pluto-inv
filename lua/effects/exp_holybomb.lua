EFFECT.g_sModelIndexFireball3 = Material("sprites/holybomb_sprite")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("HolyBomb.Explode", self.Pos, 180, 100 )
end
...
function EFFECT:Render()
	...
	render.DrawSprite(self.Pos + Vector(0, 0, 60), 256, 256, Color(255, 255, 255, 255))
end