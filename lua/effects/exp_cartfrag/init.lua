EFFECT.g_sModelIndexFireball3 = Material("sprites/cartfrag_exp")
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 23), 0, 23))
	render.DrawSprite(self.Pos + Vector(0, 0, 0), 250, 250, Color(255, 255, 255, 255))
end