EFFECT.g_sModelIndexFireball3 = Material("sprites/m24_exp")
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 15), 0, 15))
	render.DrawSprite(self.Pos + Vector(0, 0, 20), 300, 300, Color(255, 255, 255, 255))
end