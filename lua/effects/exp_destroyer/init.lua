EFFECT.g_sModelIndexFireball3 = Material("sprites/destroyer_exp")
...
function EFFECT:Init(data)
	...
	self.Frame = 0
	self.Entity:EmitSound("Destroyer.Explosion", 180, 100 )
end
...
function EFFECT:Render()
	...
	self.g_sModelIndexFireball3:SetInt("$frame", math.Clamp(math.floor(self.Frame * 21), 0, 21))
	render.DrawSprite(self.Pos + Vector(0, 0, 10), 192, 192, Color(255, 255, 255, 255))
end