...
local Mat_Impact = Material("tracers/muzzle_star")
local Mat_Beam = Material("tracers/tracer_starchaser")
local Mat_TracePart = Material("tracers/tracer_starchaser_ring")
...
local beamcol = Color(128, 128, 255, 255)
local beamcol2 = Color(255, 255, 255, 255)
