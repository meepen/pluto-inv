...
function EFFECT:Init(data)
	...
	local sparticle = emitter:Add("tracers/impact_rail", self.vOffset)
	...
	if (sparticle) then
		...
		sparticle:SetColor(192, 192, 192)
	...
	for i = 1, 1 do
		local particle = emitter:Add("tracers/impact_rail", self.vOffset)
	...
	for i = 0, 5 do
		local particle = emitter:Add("tracers/impact_rail", self.vOffset + (dir * 0.6 * i))
	...
	for i = 0, sparkcount do
		local particle = emitter:Add("tracers/impact_rail", self.Position)
