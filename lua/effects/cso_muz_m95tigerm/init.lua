...
function EFFECT:Init(data)
	...
	local sparticle = emitter:Add("tracers/muzzle_m95_nemole", self.vOffset)
	...
	for i = 1, 1 do
		local particle = emitter:Add("tracers/muzzle_m95_scotch", self.vOffset)
