...
function QUEST:Reward(data)
	...
	data.Player:ChatPrint(white_text, "You have received a ", new_item, white_text, " with the ", mod.Color or white_text, mod.Name, white_text, " modifier for completing ", self.Color, self.Name, white_text, "!")
end
