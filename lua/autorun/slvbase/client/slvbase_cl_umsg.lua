...
local function slvExtinguish(ent)
...
usermessage.Hook("slv_ignite",function(um)
	...
	local hk = "slv_entignite" .. ent:EntIndex()
	ent:CallOnRemove(hk,slvExtinguish,ent)
...
usermessage.Hook("slv_snd_new",function(um)
	...
	util.CallOnEntityValid(function(ent)
		...
		if(tbSounds[sndIdx].sec) then csp:slvFadeOut(tbSounds[sndIdx].sec); tbSounds[sndIdx] = nil; return end
