...
function meta:slvFollowBone(ent,boneID)
...
function meta:SLVFindInCone(deg,dist,filter)
...
function meta:slvDistance(TArg)
	local pos
...
function meta:GetAngleToPos(pos, _ang, bDontClamp)
	...
	if !bDontClamp then ang:slvClamp() end
	return ang
end
