...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_pumpkin.mdl")
...
function ENT:Explosion()
	...
	util.Effect("exp_pumpkin", effectdata)
	...
	local shake = ents.Create("env_shake")
		...
		shake:SetKeyValue("amplitude", "2400")	// Power of the shake
		shake:SetKeyValue("radius", "1500")		// Radius of the shake
	    ...
	    self.Entity:EmitSound("weapons/tfa_cso/pumpkin/boom.ogg", 100, 100 )
end
