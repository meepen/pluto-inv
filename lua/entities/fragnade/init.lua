...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_fragnade.mdl")
...
function ENT:Explosion()
	...
	util.Effect("exp_fragnade", effectdata)

	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 400, 150)
