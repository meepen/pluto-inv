...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_mooncake.mdl")
...
function ENT:Explosion()
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 240, 100)
	
	local shake = ents.Create("env_shake")
		shake:SetOwner(self.Owner)
		shake:SetPos(self.Entity:GetPos())
		shake:SetKeyValue("amplitude", "1200")	// Power of the shake
	    ...
	    self.Entity:EmitSound("weapons/tfa_cso/mooncake/boom.ogg", 100, 100 )
end
