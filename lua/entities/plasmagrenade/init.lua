...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_sfgrenade.mdl")
...
function ENT:Explosion()
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 300, 200)
	...
	local shake = ents.Create("env_shake")
	    ...
	    self.Entity:EmitSound("weapons/tfa_cso/sfgrenade/boom.ogg", 100, 100 )
end
