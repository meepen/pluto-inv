...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/weapons/tfa_cso/w_cartfrag.mdl")
...
function ENT:Explosion()
	...
	util.Effect("exp_cartfrag", effectdata)

	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 200, 150)
	
	local shake = ents.Create("env_shake")
		shake:SetOwner(self.Owner)
		shake:SetPos(self.Entity:GetPos())
		shake:SetKeyValue("amplitude", "1800")	// Power of the shake
	...
	self.Entity:EmitSound("weapons/explode" .. math.random(3, 5) .. ".ogg", self.Pos, 100, 100 )
end
